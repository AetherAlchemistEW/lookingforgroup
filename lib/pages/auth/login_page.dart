...
import 'package:lookingforgroup/pages/auth/register_page.dart';
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                const Text("Login now to join us",
                  style: TextStyle(
                      fontSize: 15,
                ...
                TextFormField(
                  ...
                  //check validation
                  validator: (value){
                    return RegExp(r"^[a-zA-Z0-9.!#$%&'*+-/=?^_`{|}~]+@[a-zA-Z0-9+[a-zA-Z]+").hasMatch(value!) ? null : "Please enter a valid email";
                  },
                ),
                const SizedBox(height: 10,),
                TextFormField(
  ...
  login () async {
    if(formKey.currentState!.validate()){
      ...
      await authService.signInWithEmailAndPassword(email, password).then((value) async {
        if(value==true) { //success
          //saved shared preferences state
          QuerySnapshot snapshot = await DatabaseService(uid: FirebaseAuth.instance.currentUser!.uid).gettingUserData(email);
          await HelperFunctions.saveUserLoggedInStatus(true);
          await HelperFunctions.saveUserEmailStatus(email);
          await HelperFunctions.saveUserNameStatus(snapshot.docs[0]['fullname']);
